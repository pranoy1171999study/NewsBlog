        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    $sql="SELECT post.post_id,post.title,post.description,post.post_date,post.category,post.post_img,category.category_name,user.user_id,user.username FROM post 
